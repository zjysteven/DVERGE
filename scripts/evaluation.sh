...
#    --gpu $GPUID \
#    --model-file checkpoints/dverge/seed_100/3_ResNet20_eps_0.07/epoch_200.pth \
...
python eval/eval_wbox.py \
    --gpu $GPUID \
    --model-file checkpoints/dverge/seed_101/3_ResNet20_eps_0.07/epoch_200.pth \
    --steps 50 \
    --random-start 5 \
    --save-to-csv
...
python eval/eval_wbox.py \
    --gpu $GPUID \
    --model-file checkpoints/dverge/seed_102/3_ResNet20_eps_0.07/epoch_200.pth \
    --steps 50 \
    --random-start 5 \
    --save-to-csv
